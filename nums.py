...
numS = list(filter(lambda x: x.find(".")==x.rfind(".") and x.replace(".","").isdigit(), s.split()))
num = list(map(lambda x: float(x), numS))

print("Числа в тексте: "+(" ".join(numS)))
print("Всего "+str(len(numS))+" чисел в тексте")
